...
import io.vertx.rocketmq.client.impl.consumer.DefaultLitePullConsumerImpl;
...
public class DefaultLitePullConsumer extends ClientConfig implements LitePullConsumer {
     ...
     * and 01 seconds on December 23, 2013 year<br>
     ...
     * Default constructor.
     */
    public DefaultLitePullConsumer(VertxInternal vertx, RocketmqOptions options) {
        this(null, MixAll.DEFAULT_CONSUMER_GROUP, null, vertx, options);
    }
     ...
     */
    public DefaultLitePullConsumer(final String consumerGroup, VertxInternal vertx, RocketmqOptions options) {
        this(null, consumerGroup, null, vertx, options);
    }
     ...
     */
    public DefaultLitePullConsumer(RPCHook rpcHook, VertxInternal vertx, RocketmqOptions options) {
        this(null, MixAll.DEFAULT_CONSUMER_GROUP, rpcHook, vertx, options);
    }
     ...
     * @param rpcHook RPC hook to execute before each remoting command.
     */
    public DefaultLitePullConsumer(final String consumerGroup, RPCHook rpcHook, VertxInternal vertx, RocketmqOptions options) {
        this(null, consumerGroup, rpcHook, vertx, options);
    }
     ...
     * @param rpcHook RPC hook to execute before each remoting command.
     */
    public DefaultLitePullConsumer(final String namespace, final String consumerGroup, RPCHook rpcHook, VertxInternal vertx,
            RocketmqOptions options) {
        this.namespace = namespace;
        this.consumerGroup = consumerGroup;
        defaultLitePullConsumerImpl = new DefaultLitePullConsumerImpl(this, rpcHook, vertx, options);
    }
    ...
    public Future<Void> subscribe(String topic, String subExpression) {
        return this.defaultLitePullConsumerImpl.subscribe(withNamespace(topic), subExpression);
    }

    @Override
    public Future<Void> subscribe(String topic, MessageSelector messageSelector) {
        return this.defaultLitePullConsumerImpl.subscribe(withNamespace(topic), messageSelector);
    }
    ...
    @Override
    public Future<List<MessageExt>> poll() {
    ...
    @Override
    public Future<Void> seek(MessageQueue messageQueue, long offset) {
        return this.defaultLitePullConsumerImpl.seek(queueWithNamespace(messageQueue), offset);
    }
    ...
    @Override
    public Future<Long> offsetForTimestamp(MessageQueue messageQueue, Long timestamp) {
    ...
    public void registerTopicMessageQueueChangeListener(String topic,
        ...
        this.defaultLitePullConsumerImpl.registerTopicMessageQueueChangeListener(withNamespace(topic),
                topicMessageQueueChangeListener);
    }

    @Override
    public Future<Void> commitSync() {
        return this.defaultLitePullConsumerImpl.commitAll();
    }
    ...
    public Future<Void> seekToBegin(MessageQueue messageQueue) {
        return this.defaultLitePullConsumerImpl.seekToBegin(queueWithNamespace(messageQueue));
    }

    @Override
    public Future<Void> seekToEnd(MessageQueue messageQueue) {
        return this.defaultLitePullConsumerImpl.seekToEnd(queueWithNamespace(messageQueue));
    }
