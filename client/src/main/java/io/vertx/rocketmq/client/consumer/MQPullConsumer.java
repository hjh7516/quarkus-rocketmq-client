...
public interface MQPullConsumer extends MQConsumer {
     ...
     */
    Future<PullResult> pull(final MessageQueue mq, final String subExpression, final long offset,
            final int maxNums);
     ...
     * @return The resulting {@code PullRequest}
     */
    Future<PullResult> pull(final MessageQueue mq, final MessageSelector selector, final long offset,
            final int maxNums);
     ...
     * @return The resulting {@code PullRequest}
     */
    Future<PullResult> pullBlockIfNotFound(final MessageQueue mq, final String subExpression,
     ...
     */
    Future<Long> fetchConsumeOffset(final MessageQueue mq, final boolean fromStore);
     ...
     */
    Future<Void> sendMessageBack(MessageExt msg, int delayLevel, String brokerName, String consumerGroup);
