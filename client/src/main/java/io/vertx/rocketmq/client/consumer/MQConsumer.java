...
public interface MQConsumer extends MQAdmin {
     ...
     */
    @Deprecated
    Future<Void> sendMessageBack(final MessageExt msg, final int delayLevel);

    /**
     * If consuming failure,message will be send back to the broker,and delay consuming some time
     */
    Future<Void> sendMessageBack(final MessageExt msg, final int delayLevel, final String brokerName);
     ...
     * @return queue set
     */
    Future<Set<MessageQueue>> fetchSubscribeMessageQueues(final String topic);
}
