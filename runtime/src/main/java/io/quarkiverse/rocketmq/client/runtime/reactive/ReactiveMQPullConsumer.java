...
public interface ReactiveMQPullConsumer {
     ...
     */
    Uni<PullResult> pull(final MessageQueue mq, final String subExpression, final long offset, final int maxNums);
     ...
     * @return The resulting {@code PullRequest}
     */
    Uni<PullResult> pull(final MessageQueue mq, final MessageSelector selector, final long offset, final int maxNums);
     ...
     * @return The resulting {@code PullRequest}
     */
    Uni<PullResult> pullBlockIfNotFound(final MessageQueue mq, final String subExpression, final long offset,
            final int maxNums);
     ...
     * @return queue set
     */
    Uni<Set<MessageQueue>> fetchSubscribeMessageQueues(final String topic);
}
